...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
		{
			throw new TreeException("Invalid input1");
		}
		...
		if (root == null)
		{
			root = parentNode = new TreeNode(parent);
		}
		else
		{
			...
			if (parentNode == null)
			{
				throw new TreeException("Error in data file");
			}
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
		{
			throw new TreeException("Invalid input2");
		}
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
		{
			throw new TreeException("Invalid input3");
		}
